...
public:
	...
	virtual void sphereOverlay(const Vector& vOrigin, float radius, int nTheta, int nPhi, int r, int g, int b, int a, float duration) = 0;
	...
	virtual void screenTextOverlay(float flXPos, float flYPos, float duration, int r, int g, int b, int a, const char* text) = 0;
	...
	virtual void coordFrameOverlay(const matrix3x4& frame, float flScale, int vColorTable[3][3] = NULL) = 0;
	...
	virtual void addLineOverlay(const Vector& origin, const Vector& ukn, int r, int g, int b, int a, float duration, float ukn1) = 0;
	virtual void purgeTextOverlays() = 0;
	virtual void capsuleOverlay(const Vector& vStart, const Vector& vEnd, const float& radius, int r, int g, int b, int a, float duration, int unk, int occlude) = 0;
};