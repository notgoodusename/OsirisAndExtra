...
void Visuals::playerModel(FrameStage stage) noexcept
{
    ...
    constexpr auto getModel = [](Team team) constexpr noexcept -> const char* {
        ...
        "player/custom_player/legacy/ctm_gign.mdl",
        "player/custom_player/legacy/ctm_gign_varianta.mdl",
        "player/custom_player/legacy/ctm_gign_variantb.mdl",
        "player/custom_player/legacy/ctm_gign_variantc.mdl",
        "player/custom_player/legacy/ctm_gign_variantd.mdl",
