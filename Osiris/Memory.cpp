...
Memory::Memory() noexcept
{
    ...
    clMsgMoveDescontructor = relativeToAbsolute<decltype(clMsgMoveDescontructor)>(findPattern(ENGINE_DLL, "\xFF\x90????\x8D\x4D\xA8\xE8????\x5F\x5E\x5B\x8B\xE5\x5D\xC3") + 10);
