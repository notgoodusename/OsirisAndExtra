...
void Misc::knifeBot(UserCmd* cmd) noexcept
{
    ...
    const auto angle{ Aimbot::calculateRelativeAngle(localPlayerEyePosition, bestTarget->getBonePosition(7), cmd->viewangles + aimPunch) };
