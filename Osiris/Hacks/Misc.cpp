...
void Misc::watermark() noexcept
{
    ...
    ImGui::SetCursorPos(ImVec2{ 15 - config->misc.textoffset, 5 + config->misc.textoffset}); ImGui::TextColored(ImColor(70, 50, 240, 200), "Osility \u043e\u0441\u0438\u043b\u0438\u0442\u044c");
    ImGui::SetCursorPos(ImVec2{ 15 + config->misc.textoffset, 5 - config->misc.textoffset}); ImGui::TextColored(ImColor(235, 5, 85, 200), "Osility \u043e\u0441\u0438\u043b\u0438\u0442\u044c");
    ImGui::SetCursorPos(ImVec2{ 15, 5 }); ImGui::TextColored(ImColor(245, 245, 245, 245), "Osility \u043e\u0441\u0438\u043b\u0438\u0442\u044c");
